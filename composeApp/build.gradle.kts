...
android {
    namespace = "com.ailtontech.animeseas"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.ailtontech.animeseas.androidApp"
        versionCode = 1
        versionName = "1.0.0"
    }
...
compose.desktop {
    application {
        ...
        nativeDistributions {
            ...
            packageName = "com.ailtontech.animeseas.desktopApp"
...
sqldelight {
    databases {
        create("MyDatabase") {
            ...
            packageName.set("com.ailtontech.animeseas.db")
        }
    }
}
